...
namespace FastRouting.Services.Services
{
    ...
    {
        private readonly ICentersRepository _shoppingMallRepository;
        ...
        //        Name=centerName
        //    };
        //    CentersDTO shoppingMall2= await AddAsync(shoppingMall);
        ...
        public async Task<CentersDTO> AddAsync(CentersDTO Centers)
        {
            return _mapper.Map<CentersDTO>(await _shoppingMallRepository.AddAsync(_mapper.Map<Centers>(Centers)));
        ...
        public async Task<List<CentersDTO>> GetAllAsync()
        {
            return _mapper.Map<List<CentersDTO>>(await _shoppingMallRepository.GetAllAsync());

        }

        public async Task<CentersDTO> GetByIdAsync(int id)
        {
            return _mapper.Map<CentersDTO>(await _shoppingMallRepository.GetByIdAsync(id));

        }
        public async Task<CentersDTO> GetByNameAsync(string name)
        {
            return _mapper.Map<CentersDTO>(await _shoppingMallRepository.GetByNameAsync(name));

        }

        public async Task<CentersDTO> UpdateAsync(CentersDTO Centers)
        {
            return _mapper.Map<CentersDTO>(await _shoppingMallRepository.UpdateAsync(_mapper.Map<Centers>(Centers)));

        }

        //public async Task<bool> CreateNewMall(CentersDTO shoppingMall, List<TheCenterPhotoDTO> TheCenterPhotoDTOList,List<LocationsDTO> locations, List<IntersectionsDTO> intersections, List<List<int>> passCodes, List<dynamic> edgesCrossFloors)
        //{
